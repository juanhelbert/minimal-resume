const data = {
  filters: [
    'All', 'React', 'NextJs', 'GraphQL', 'SEO', 'PWA', 'Gatsby'
  ],
  types: [
    'All', 'Personal', 'Freelance', 'Job'
  ],
  projects: [
    {
      title: 'Rock, paper, scissors',
      description: 'A simple game and a fun way to implement some ideas that I had.',
      tags: ['All', 'NextJs', 'React', 'CSS'],
      type: ['All', 'Personal'],
      ...
      tags: ['All', 'React', 'SEO', 'Accessibility'],
      type: ['All', 'Job'],
